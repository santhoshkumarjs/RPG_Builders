	...
	b = function () {
		function c(c, d) {
			...
			e.defaults = {
				...
				arrows: !0,
				asNavFor: null,
				prevArrow: '<button type="button" data-role="none" class="flaticon-direction196 drill-prev" aria-label="Previous" tabindex="0" role="button"></button>',
				nextArrow: '<button type="button" data-role="none" class="flaticon-direction202 drill-next" aria-label="Next" tabindex="0" role="button"></button>',
				autoplay: !1,
				autoplaySpeed: 3e3,
				centerMode: !1,
				centerPadding: "50px",
				...
				dots: !1,
				dotsClass: "drill-dots", /*slick-dots*/
				draggable: !0,
				easing: "linear",
				edgeFriction: .35,
				fade: !1,
